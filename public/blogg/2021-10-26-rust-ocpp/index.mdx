...
Tråkigt nog saknades det ett lib i [rust](https://rust-lang.org) 🦀 som vi är stora fans av. Så vi bestämde oss för att skriva
ett själva och har nu släppt det som open source 🎉! Woho!

Släppt som en crate här: [crates.io](https://crates.io/crates/rust-ocpp)

Och källkoden finns tillgänglig här: [github](https://github.com/codelabsab/rust-ocpp)
