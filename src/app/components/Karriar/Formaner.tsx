      ...
      <div className=" max-w-7xl mx-auto flex lg:pb-28 pb-8 justify-center items-center flex-col">
        ...
        <div className="flex text-center flex-wrap">
          {formansData.map((data, index) => {
            return (
              <div key={index} className="border-b-2 border-r-2 border-l-2 border-separate border-blue-lightest px-12 pb-5 pt-5 lg:w-1/3 md:w-2/4 w-full flex flex-col items-center">
